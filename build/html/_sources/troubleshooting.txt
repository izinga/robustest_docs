...
===============
 ...
 .. image:: _static/dilbert_troubleshooting.gif
 ...
 * I ran my automation tests on the RobusTest Hub but I do not see anything in Live View
   ...
   A build URL is generated uniquely for every build and user. So, this could be because the build URL you are using to run your tests belongs to another person (and s/he is seeing an entry in his/her live view)